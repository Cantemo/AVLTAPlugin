...
class SettingsForm(forms.Form):
    AV_LTA_APPS_URL = forms.CharField(
        label=_("LTA Apps URL"),
        help_text=_("URL to the LTA deployment to proxy to"),
        required=False
    )
    ...
    AV_LTA_EXTRA_SETTINGS = forms.CharField(
        ...
        help_text=SafeString(
            _("Settings to always include in each Launch Template. Must be valid a valid JSON object. Read more about the available settings <a href='https://apps.accurate.video/docs/validate/reference/launch-template-settings' target='blank'>here</a>")),
