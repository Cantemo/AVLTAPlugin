...
1. Download and install
    ...
    ```
2. Activate the plugin by opening admin page in Cantemo. The plugin is listed there as _"Accurate Video LTA Plugin"_. Activate it.
3. Assign the _"AV LTA Roles" > "Subtitle"_ to the users/groups that should have access.
